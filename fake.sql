...
<script data-cfasync='false' type='text/javascript' src='js/messages.php?l=id&amp;v=4.9.0.1'></script>
...
PMA_commonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"id",server:"1",table:"",db:"",token:"2646aed5348f4ace837b4bdb756071ee",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Jelajahi",pma_text_left_default_tab:"Struktur",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"2700",logged_in:true,is_https:false,rootPath:"/",arg_separator:"&",PMA_VERSION:"4.9.0.1",auth_type:"signon",user:"epiz_26633400"});
...
<!-- LINKS START --><div id="navipanellinks"><a href="index.php" title="Beranda"><img src="themes/dot.gif" title="Beranda" alt="Beranda" class="icon ic_b_home" /></a><a href="logout.php" class="logout disableAjax" title="Keluar"><img src="themes/dot.gif" title="Keluar" alt="Keluar" class="icon ic_s_loggoff" /></a><a href="./doc/html/index.html" target="documentation" title="Dokumentasi phpMyAdmin"><img src="themes/dot.gif" title="Dokumentasi phpMyAdmin" alt="Dokumentasi phpMyAdmin" class="icon ic_b_docs" /></a><a href="./url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.6%2Fen%2Findex.html" target="mysql_doc" title="Dokumentasi"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_sqlhelp" /></a><a href="#" id="pma_navigation_settings_icon" title="Pengaturan panel navigasi"><img src="themes/dot.gif" title="Pengaturan panel navigasi" alt="Pengaturan panel navigasi" class="icon ic_s_cog" /></a><a href="#" id="pma_navigation_reload" title="Muat ulang panel navigasi"><img src="themes/dot.gif" title="Muat ulang panel navigasi" alt="Muat ulang panel navigasi" class="icon ic_s_reload" /></a></div><!-- LINKS ENDS --><img src="themes/dot.gif" title="Memproses…" alt="Memproses…" style="visibility: hidden; display:none" class="icon ic_ajax_clock_small throbber" /></div><div id="pma_navigation_tree" class="list_container synced highlight"><div class="pma_quick_warp"><div class="drop_list"><span title="Tabel terakhir" class="drop_button">Terbaru</span><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=epiz_26633400_server&amp;table=fake">`epiz_26633400_server`.`fake`</a></li></ul></div><div class="drop_list"><span title="Tabel favorit" class="drop_button">Favorit</span><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div><div class="clearfloat"></div><ul><!-- CONTROLS START --><li id="navigation_controls_outer"><div id="navigation_controls"><a href="#" id="pma_navigation_collapse" title="Tutup semua"><img src="themes/dot.gif" title="Tutup semua" alt="Tutup semua" class="icon ic_s_collapseall" /></a><a href="#" id="pma_navigation_sync" title="Unlink dari panel utama"><img src="themes/dot.gif" title="Unlink dari panel utama" alt="Unlink dari panel utama" class="icon ic_s_link" /></a></div></li><!-- CONTROLS ENDS --></ul><div id='pma_navigation_tree_content'><ul><li class="first new_database italics"><div class='block'><i class='first'></i></div><div class='block '><a href='server_databases.php?server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb" /></a></div><a class='hover_show_full' href='server_databases.php?server=1' title=''>Baru</a><div class="clearfloat"></div></ul></div></div><div id="pma_navi_settings_container"><div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="export.php?db=&amp;table=&amp;server=1&amp;target=" class="config-form disableAjax"><input type="hidden" name="tab_hash" value="" /><input type="hidden" name="check_page_refresh"  id="check_page_refresh" value="" />
<input type="hidden" name="token" value="2646aed5348f4ace837b4bdb756071ee" />
<input type="hidden" name="submit_save" value="Navi" /><input type="hidden" name="token" value="2646aed5348f4ace837b4bdb756071ee" /><ul class="tabs responsivetable">
...
</span><small>Setel ke 0 untuk menutup panel navigasi.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" value="0" /><a class="restore-default hide" href="#NavigationWidth" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload" /></a></td></tr></table>
</fieldset>
...
</div></div></div></div><div class="pma_drop_handler">Letakkan berkas disini</div><div class="pma_sql_import_status"><h2>SQL upload ( <span class="pma_import_count">0</span> ) <span class="close">x</span><span class="minimize">-</span></h2><div></div></div></div><noscript><div class="error"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> Javascript harus diaktifkan lewat point ini!</div></noscript><div id='floating_menubar'></div><div id='serverinfo'><img src="themes/dot.gif" title="" alt="" class="icon ic_s_host item" /><a href="index.php" class="item">Server: sql205.epizy.com</a><div class="clearfloat"></div></div><div id="topmenucontainer" class="menucontainer"><i class="scrollindicator scrollindicator--left"><a href="#" class="tab"></a></i><div class="navigationbar"><ul id="topmenu"  class="resizable-menu"><li>
...
<span id="page_nav_icons"><span id="lock_page_icon"></span><span id="page_settings_icon"><img src="themes/dot.gif" title="Pengaturan Terkait dengan Halaman" alt="Pengaturan Terkait dengan Halaman" class="icon ic_s_cog" /></span><a id="goto_pagetop" href="#"><img src="themes/dot.gif" title="Klik pada bar untuk menggulir ke atas halaman" alt="Klik pada bar untuk menggulir ke atas halaman" class="icon ic_s_top" /></a></span><div id="pma_console_container">
    <div id="pma_console">
...
<p>export.php: Parameter yang hilang: what<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help" /></a><br />export.php: Parameter yang hilang: export_type<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help" /></a><br /></p>
</body>
</html>
</div><div id="selflink" class="print_ignore"><a href="export.php?db=&amp;table=&amp;server=1&amp;target=" title="Buka jendela phpMyAdmin baru" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="Buka jendela phpMyAdmin baru" alt="Buka jendela phpMyAdmin baru" class="icon ic_window-new" /></a></div><div class="clearfloat" id="pma_errors"></div><script data-cfasync="false" type="text/javascript">// <![CDATA[
